...
/**
	...
	Acceso a BD con MySQLi y consultas parametrizadas.

	Añadidas condiciones para loggeo y Singleton.

	MTI Carlos Daniel Lima Romero
...

{
...

    {
		...
		$username="vmiagen1_bachocofootservice";

		$password="EgCm%G&]cOaA";

		$db="vmiagen1_foodService";
